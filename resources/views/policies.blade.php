...
<html lang="en">
    ...
    <body>
        ...
        <div class="main-banner">
            <div class="container">
                <h1 data-aos="fade-zoom-in" data-aos-duration="300" data-aos-easing="ease-in-sine" data-aos-once="true">UOM Policies</h1>
                <p data-aos="fade-zoom-in" data-aos-duration="300" data-aos-delay="100" data-aos-easing="ease-in-sine" data-aos-once="true">
        ...
        <!-- Policies -->
        <div class="policies" data-aos="fade-up" data-aos-duration="400" data-aos-easing="ease-in-sine" data-aos-once="true">
            <div class="container">
                <!-- Policies Head -->
                <div class="policies-head">
                    <div class="row">
                        <div class="col-md-10">
                            <h6 class="h7 fw-500 mb-0">Policies</h6>
                        </div>
                        <div class="col-md-2">
                            <h6 class="h7 fw-500 mb-0">Status</h6>
                        </div>
                    </div>
                </div>
                <!--/ Policies Head -->
