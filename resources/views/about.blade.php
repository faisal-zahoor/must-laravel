...
@section('content')
    ...
    <div class="main-banner">
        <div class="container">
            <h1 data-aos="fade-zoom-in" data-aos-duration="300" data-aos-easing="ease-in-sine" data-aos-once="true">About UOM
            </h1>
    ...
    <div class="how-to-apply">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 hta-content-right" data-aos="fade-right" data-aos-duration="400"
                    data-aos-easing="ease-in-sine" data-aos-once="true">
                    <h2>About UOM</h2>
                    <p>
                ...
                <div class="offset-lg-1 col-lg-5 hta-content-left" data-aos="fade-left" data-aos-duration="400"
                    data-aos-easing="ease-in-sine" data-aos-once="true">
                    <img class="img-fluid" src="images/how-to-apply.png" alt="How to apply" width="483" height="368" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="design-section">
        <div class="container">
            <h2 data-aos="fade-up" data-aos-duration="400" data-aos-easing="ease-in-sine" data-aos-once="true">Lorem Ipsum
            </h2>
            <p class="text-gray-700" data-aos="fade-up" data-aos-duration="400" data-aos-delay="100"
                data-aos-easing="ease-in-sine" data-aos-once="true">
            ...
            <div class="row">
                <div class="col-md-4" data-aos="fade-up" data-aos-duration="400" data-aos-delay="200"
                    ...
                    <a href="degree-overview.html">
                        <!-- Img Overlay Text -->
                        <div class="img-overlay-text-v2">
                            <img class="img-fluid" src="images/design.jpg" alt="Design" width="380" height="444" />
                            <!-- Iot Content -->
                            <div class="iot-content">
                                <div>
                                    <h3 class="h4 fw-500">Design</h3>
                                    <p>
                ...
                <div class="col-md-4" data-aos="fade-up" data-aos-duration="400" data-aos-delay="300"
                    data-aos-easing="ease-in-sine" data-aos-once="true">
                    <a href="/degree-overview.html">
                        <!-- Img Overlay Text -->
                        <div class="img-overlay-text-v2">
                ...
                <div class="col-md-4" data-aos="fade-up" data-aos-duration="400" data-aos-delay="500"
                    ...
                    <a href="/degree-overview.html">
                        <!-- Img Overlay Text -->
                        <div class="img-overlay-text-v2">
                            <img class="img-fluid" src="images/design.jpg" alt="Design" width="380"
                                height="444" />
                            <!-- Iot Content -->
                            <div class="iot-content">
                                <div>
                ...
                <div class="col-md-4" data-aos="fade-up" data-aos-duration="400" data-aos-delay="700"
                    data-aos-easing="ease-in-sine" data-aos-once="true">
                    <a href="/degree-overview.html">
                        <!-- Img Overlay Text -->
                        <div class="img-overlay-text-v2">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 gs-content-left" data-aos="fade-right" data-aos-duration="400"
                    data-aos-easing="ease-in-sine" data-aos-once="true">
                    <span class="text-primary h7 fw-500 caption">We’ve helped hundreds of companies</span>
        ...
        <div class="container">
            ...
            <div class="tab-content" id="newsEventsTabContent">
                ...
                <div class="tab-pane fade show active" id="news-tab-pane" role="tabpanel" aria-labelledby="news-tab"
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <img class="img-fluid" src="images/news-events/news-one.jpg" alt="Arts Society"
                        ...
                        <div class="col-md-3">
                            <img class="img-fluid" src="images/news-events/news-two.jpg" alt="Arts Society"
                                width="280" height="217" />
                            <h3 class="h5">Arts Society</h3>
                            <p class="small">Lorem Ipsum is simply dummy text of the printing and</p>
                            <a href="/degree-overview.html" class="btn btn-outline-secondary">Learn More</a>
                        ...
                        <div class="col-md-3">
                            <img class="img-fluid" src="images/news-events/news-three.jpg" alt="Arts Society"
                                width="280" height="217" />
                            <h3 class="h5">Arts Society</h3>
                            <p class="small">Lorem Ipsum is simply dummy text of the printing and</p>
                            <a href="/degree-overview.html" class="btn btn-outline-secondary">Learn More</a>
                        ...
                        <div class="col-md-3">
                            <img class="img-fluid" src="images/news-events/news-four.jpg" alt="Arts Society"
                                width="280" height="217" />
                            <h3 class="h5">Arts Society</h3>
                            <p class="small">Lorem Ipsum is simply dummy text of the printing and</p>
                            <a href="/degree-overview.html" class="btn btn-outline-secondary">Learn More</a>
                        ...
                        <div class="col-md-3">
                            <img class="img-fluid" src="images/news-events/news-five.jpg" alt="Arts Society"
                                width="280" height="217" />
                            <h3 class="h5">Arts Society</h3>
                            <p class="small">Lorem Ipsum is simply dummy text of the printing and</p>
                            <a href="/degree-overview.html" class="btn btn-outline-secondary">Learn More</a>
                        ...
                        <div class="col-md-3">
                            <img class="img-fluid" src="images/news-events/news-six.jpg" alt="Arts Society"
                                width="280" height="217" />
                            <h3 class="h5">Arts Society</h3>
                            <p class="small">Lorem Ipsum is simply dummy text of the printing and</p>
                            <a href="/degree-overview.html" class="btn btn-outline-secondary">Learn More</a>
                        ...
                        <div class="col-md-3">
                            <img class="img-fluid" src="images/news-events/news-seven.jpg" alt="Arts Society"
                                width="280" height="217" />
                            <h3 class="h5">Arts Society</h3>
                            <p class="small">Lorem Ipsum is simply dummy text of the printing and</p>
                            <a href="/degree-overview.html" class="btn btn-outline-secondary">Learn More</a>
                        ...
                        <div class="col-md-3">
                            <img class="img-fluid" src="images/news-events/news-eight.jpg" alt="Arts Society"
                                width="280" height="217" />
                            <h3 class="h5">Arts Society</h3>
                            <p class="small">Lorem Ipsum is simply dummy text of the printing and</p>
                            <a href="/degree-overview.html" class="btn btn-outline-secondary">Learn More</a>
    ...
    <div class="our-vision-mission">
        <div class="container">
            <div class="row">
                <div class="col-md-6 ovam-content-left" data-aos="fade-right" data-aos-duration="400" data-aos-delay="0"
                    data-aos-easing="ease-in-sine" data-aos-once="true">
                    <img class="img-fluid" src="images/our-vision.png" alt="Our Vision" width="381"
                        height="397" />
                </div>
                <div class="col-md-6 ovam-content-right" data-aos="fade-left" data-aos-duration="400" data-aos-delay="0"
                    data-aos-easing="ease-in-sine" data-aos-once="true">
                    <h2>Our Vision</h2>
                    <p>
                        Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
    ...
    <div class="our-vision-mission">
        <div class="container">
            <div class="row">
                <div class="col-md-6 ovam-content-left" data-aos="fade-right" data-aos-duration="400" data-aos-delay="0"
                    data-aos-easing="ease-in-sine" data-aos-once="true">
                    <img class="img-fluid" src="images/our-mission.png" alt="Our Mission" width="381"
                        height="397" />
                </div>
                <div class="col-md-6 ovam-content-right" data-aos="fade-left" data-aos-duration="400" data-aos-delay="0"
                    data-aos-easing="ease-in-sine" data-aos-once="true">
    ...
    <div class="cta-wrap" data-aos="fade-up" data-aos-duration="400" data-aos-delay="300"
        ...
        <div class="container">
            ...
            <div class="call-to-action">
                ...
                <a href="/degree-overview.html)" class="btn btn-primary">Get in touch</a>
            </div>
            <!--/ Call to Action -->
        </div>
    </div>
