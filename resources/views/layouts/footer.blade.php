...
<div class="cta-wrap" data-aos="fade-up" data-aos-duration="400" data-aos-delay="300" data-aos-easing="ease-in-sine"
    ...
    <div class="container">
        ...
        <div class="call-to-action">
            <img src="{{ URL('images/cta-img.png') }}" alt="Cta Img" width="120" height="56" />
            <h2 class="h5 fw-500">Still have questions?</h2>
            <p>Can’t find the answer you’re looking for? Please chat to our friendly team.</p>
            <a href="{{ URL('contact-us') }}" class="btn btn-primary">Get in touch</a>
        </div>
        <!--/ Call to Action -->
    </div>
</div>
...
<footer class="footer">
    <div class="container ft-container">
        <div class="row">
            <!-- First Col -->
            <div class="first-col">
                <img class="img-fluid footer-logo" src="{{ URL('images/common/uom-logo-black.svg') }}"
                    alt="Multan University Logo" width="196" height="46" />
                <p>
            ...
            <div class="fourth-col">
                ...
                <ul>
                    <li><a href="{{ URL('apply-now') }}">Student Portal</a></li>
                </ul>
            </div>
            <!--/ Fourth Col -->
        </div>
