...
<html lang="en">
    <head>
        ...
        <link href="cheatsheet/css/cheatsheet.css" rel="stylesheet" />
    </head>
    <body class="bg-light">
        <header class="bd-header bg-dark py-3 d-flex align-items-stretch border-bottom border-dark">
            <div class="container-fluid d-flex align-items-center">
                <h1 class="d-flex align-items-center fs-4 text-white mb-0">Cheatsheet</h1>
                <a href="https://getbootstrap.com/docs/5.0/examples/cheatsheet-rtl/" class="ms-auto link-light" hreflang="ar"
                    >RTL cheatsheet</a
                >
            </div>
        </header>
        ...
        <div class="bd-cheatsheet container-fluid bg-body">
                ...
                <article class="my-3" id="images">
                    ...
                    <div>
                        ...
                        <div class="bd-example">
                            ...
                            >
                                <title>
                                    A generic square placeholder image with a white border around it, making it resemble a photograph taken
            ...
            <section id="forms">
                ...
                <article class="my-3" id="disabled-forms">
                    <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                        ...
                        <a class="d-flex align-items-center" href="https://getbootstrap.com/docs/5.0/forms/overview/#disabled-forms"
                            >Documentation</a
                        >
                    </div>
                ...
                <article class="my-3" id="sizing">
                    <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                        <h3>Sizing</h3>
                        <a class="d-flex align-items-center" href="https://getbootstrap.com/docs/5.0/forms/form-control/#sizing"
                            >Documentation</a
                        >
                    </div>
                ...
                <article class="my-3" id="floating-labels">
                    <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                        ...
                        <a class="d-flex align-items-center" href="https://getbootstrap.com/docs/5.0/forms/floating-labels/"
                            >Documentation</a
                        >
                    </div>
            ...
            <section id="components">
                ...
                <article class="my-3" id="accordion">
                    <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                        <h3>Accordion</h3>
                        <a class="d-flex align-items-center" href="https://getbootstrap.com/docs/5.0/components/accordion/"
                            >Documentation</a
                        >
                    </div>
                ...
                <article class="my-3" id="breadcrumb">
                    <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                        <h3>Breadcrumb</h3>
                        <a class="d-flex align-items-center" href="https://getbootstrap.com/docs/5.0/components/breadcrumb/"
                            >Documentation</a
                        >
                    </div>
                ...
                <article class="my-3" id="button-group">
                    <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                        <h3>Button group</h3>
                        <a class="d-flex align-items-center" href="https://getbootstrap.com/docs/5.0/components/button-group/"
                            >Documentation</a
                        >
                    </div>
                ...
                <article class="my-3" id="dropdowns">
                    <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                        <h3>Dropdowns</h3>
                        <a class="d-flex align-items-center" href="https://getbootstrap.com/docs/5.0/components/dropdowns/"
                            >Documentation</a
                        >
                    </div>
                ...
                <article class="my-3" id="list-group">
                    <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                        <h3>List group</h3>
                        <a class="d-flex align-items-center" href="https://getbootstrap.com/docs/5.0/components/list-group/"
                            >Documentation</a
                        >
                    </div>
                ...
                <article class="my-3" id="navs">
                    <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                        <h3>Navs</h3>
                        <a class="d-flex align-items-center" href="https://getbootstrap.com/docs/5.0/components/navs-tabs/"
                            >Documentation</a
                        >
                    </div>
                        ...
                        <div class="bd-example">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                    <p>
                                        <strong>This is some placeholder content the Home tab's associated content.</strong> Clicking
                                ...
                                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                    <p>
                                        <strong>This is some placeholder content the Profile tab's associated content.</strong> Clicking
                                        another tab will toggle the visibility of this one for the next. The tab JavaScript swaps classes to
                                        control the content visibility and styling. You can use it with tabs, pills, and any other
                                        <code>.nav</code>-powered navigation.
                                    </p>
                                ...
                                <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                    <p>
                                        <strong>This is some placeholder content the Contact tab's associated content.</strong> Clicking
                                        another tab will toggle the visibility of this one for the next. The tab JavaScript swaps classes to
                                        control the content visibility and styling. You can use it with tabs, pills, and any other
                                        <code>.nav</code>-powered navigation.
                                    </p>
                ...
                <article class="my-3" id="pagination">
                    <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                        <h3>Pagination</h3>
                        <a class="d-flex align-items-center" href="https://getbootstrap.com/docs/5.0/components/pagination/"
                            >Documentation</a
                        >
                    </div>
                ...
                <article class="my-3" id="scrollspy">
                    <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                        <h3>Scrollspy</h3>
                        <a class="d-flex align-items-center" href="https://getbootstrap.com/docs/5.0/components/scrollspy/"
                            >Documentation</a
                        >
                    </div>
        ...
        <script src="cheatsheet/js/cheatsheet.js"></script>
    </body>
</html>
